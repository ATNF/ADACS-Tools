...
#run the simulator
mpiexec -n 2 -oversubscribe $CSIM -c chan_1.in
mpiexec -n 2 -oversubscribe $CSIM -c chan_2.in
mpiexec -n 2 -oversubscribe $CSIM -c chan_3.in
mpiexec -n 2 -oversubscribe $CSIM -c chan_4.in
mpiexec -n 2 -oversubscribe $CSIM -c chan_5.in
mpiexec -n 2 -oversubscribe $CSIM -c chan_6.in
mpiexec -n 2 -oversubscribe $CSIM -c chan_7.in
mpiexec -n 2 -oversubscribe $CSIM -c chan_8.in
